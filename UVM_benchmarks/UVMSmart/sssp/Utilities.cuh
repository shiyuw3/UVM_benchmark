...
//
// template <class T>
// thrust::pair<T *, T *> h_Cartesian2Polar(const T * __restrict__ d_x,
//                                          const T * __restrict__ d_y,
//                                          const int N,
//                                          const T a = static_cast<T>(1));
...
template <class T>
void linearCombination(const T * __restrict__, const T * __restrict__,
                       T * __restrict__, const int, const int,
                       const cublasHandle_t);

void linearCombination(const float * __restrict__, const float * __restrict__,
                       float * __restrict__, const int, const int,
                       const cublasHandle_t);

void linearCombination(const double * __restrict__, const double * __restrict__,
