...
__global__ void gramschmidt_kernel1(DATA_TYPE *a, DATA_TYPE *r,
                                    DATA_TYPE *q, int k) {
...
__global__ void gramschmidt_kernel2(DATA_TYPE *a, DATA_TYPE *r,
                                    DATA_TYPE *q, int k) {
...
__global__ void gramschmidt_kernel3(DATA_TYPE *a, DATA_TYPE *r,
                                    DATA_TYPE *q, int k) {
