...
void init_array(DATA_TYPE* A, DATA_TYPE* x1, DATA_TYPE* x2,
                DATA_TYPE* y1, DATA_TYPE* y2,
                DATA_TYPE* a_gpu, DATA_TYPE* x1_gpu, DATA_TYPE* x2_gpu,
                DATA_TYPE* y_1_gpu, DATA_TYPE* y_2_gpu) {
  int i, j;
...
void runMvt(DATA_TYPE* a, DATA_TYPE* x1, DATA_TYPE* x2,
            DATA_TYPE* y1, DATA_TYPE* y2) {
  int i, j;
...
void compareResults(DATA_TYPE* x1, DATA_TYPE* x1_outputFromGpu,
                    DATA_TYPE* x2, DATA_TYPE* x2_outputFromGpu) {
  int i, fail;
  fail = 0;
...
void mvtCuda(DATA_TYPE* a_gpu, DATA_TYPE* x1_gpu, DATA_TYPE* x2_gpu,
             DATA_TYPE* y_1_gpu, DATA_TYPE* y_2_gpu) {
