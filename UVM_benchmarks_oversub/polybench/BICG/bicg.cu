...
void init_array(DATA_TYPE *A, DATA_TYPE *p, DATA_TYPE *r, DATA_TYPE *A_gpu,
                DATA_TYPE *p_gpu, DATA_TYPE *r_gpu) {
  int i, j;
...
void compareResults(DATA_TYPE* s, DATA_TYPE* s_outputFromGpu,
...
void bicg_cpu(DATA_TYPE* A, DATA_TYPE* r, DATA_TYPE* s,
              DATA_TYPE* p, DATA_TYPE* q) {
  int i, j;
...
void bicgCuda(DATA_TYPE* A_gpu, DATA_TYPE* r_gpu, DATA_TYPE* s_gpu,
              DATA_TYPE* p_gpu, DATA_TYPE* q_gpu) {
